...
const ConfirmDeleteModal: FC<ModalProps> = observer(
  ({ onCancel, onClick, title, chosenWord }) => {
    const handleClick = () => {
      console.log(toJS(chosenWord))
      console.log(chosenWord.id)
      console.log(toJS(chosenWord).id)
      // console.log("remove : " + chosenWord.id)
      onClick(chosenWord.id)
      onCancel()
    }
    return (
      <Modal>
        ...
        <div className="flex flex-col items-center justify-center h-full  ">
          ...
          <div className="p-2 flex flex-col items-center justify-start h-full  ">
            ...
            <div className="flex flex-col items-center mt-5">
              are you sure you want to delete category: {chosenWord.name}
            </div>
          </div>
          {/* buttons */}
